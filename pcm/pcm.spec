...
Patch0:         0001-fix-hang-on-pthread_setaffinity_np-failure.patch
...
mkdir build
cd build
cmake3 -DCMAKE_INSTALL_PREFIX=$RPM_BUILD_ROOT/ -DCMAKE_BUILD_TYPE=RelWithDebInfo ..
make -j 
...
%changelog
* Mon May 20 2022 - lei.chen@smartx.com
        use ctrl-c to exit when pthread_set_affinity_np fails
